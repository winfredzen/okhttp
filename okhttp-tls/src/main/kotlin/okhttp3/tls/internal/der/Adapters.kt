...
internal object Adapters {
  val ANY_VALUE = object : DerAdapter<AnyValue>(tagClass = -1, tag = -1L) {
    override fun decode(reader: DerReader, header: DerHeader): AnyValue {
  ...
  val NULL = object : DerAdapter<Unit?>(
    ...
    override fun decode(reader: DerReader, header: DerHeader) = null
  }
